...
@section('content')
    <div class="mb-3">
        ...
        <h1 class="page-title">{{ __('outlet.list') }}
            <small>{{ __('app.total') }} : {{ $outlets->total() }} {{ __('outlet.outlet') }}</small>
        </h1>
    </div>
                ...
                <div class="card-header">
                    <form method="GET" action="" accept-charset="UTF-8" class="form-inline">
                        <div class="form-group">
                            ...
                            <input placeholder="{{ __('outlet.search_text') }}" name="q" type="text" id="q"
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('outlets.show', $outlet) }}"
                                   id="show-outlet-{{ $outlet->id }}">{{ __('app.show') }}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
