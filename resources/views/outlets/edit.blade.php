                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <form method="POST" action="{{ route('outlets.destroy', $outlet) }}" accept-charset="UTF-8"
                                ...
                                <button type="submit"
                                        class="btn btn-danger">{{ __('app.delete_confirm_button') }}</button>
                            </form>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="address"
                                          ...
                                          name="address" rows="4">{{ old('address', $outlet->address) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="latitude" type="text"
                                               ...
                                               name="latitude" value="{{ old('latitude', $outlet->latitude) }}"
                                               required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="longitude" type="text"
                                               ...
                                               name="longitude" value="{{ old('longitude', $outlet->longitude) }}"
                                               required>
